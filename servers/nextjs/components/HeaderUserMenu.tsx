...
/**
 * Avatar + dropdown with Sign out. Fetches the session from NextAuth's
 * `/api/auth/session` so the header has live identity without threading
 * it through as a prop.
 */
