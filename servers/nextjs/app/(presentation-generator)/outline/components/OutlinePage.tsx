            ...
            <div className="fixed top-26 left-0 right-0 z-40 bg-[#FAFAFA] pb-2">
              <div className="mx-auto w-full max-w-[1440px] px-5 sm:px-10 lg:px-20">
                <TabsList className="my-4 h-auto w-fit rounded-full border border-[#EDEEEF] bg-white p-1.5">
                  <TabsTrigger
                    value={TABS.OUTLINE}
                    className="rounded-full px-5 py-2  text-xs font-medium text-[#2D2D2D] shadow-none data-[state=active]:bg-[#E6FBF1] data-[state=active]:text-[#7E3AF2] data-[state=active]:shadow-none"
                  >
                    Outline & Content
                  </TabsTrigger>
                  ...
                  <TabsTrigger
                    value={TABS.LAYOUTS}
                    className="relative rounded-full px-5  py-2 text-xs font-medium text-[#2D2D2D] shadow-none  data-[state=active]:bg-[#E6FBF1] data-[state=active]:text-[#7E3AF2] data-[state=active]:shadow-none"
                  >
                    Select Template
                  </TabsTrigger>
                </TabsList>
