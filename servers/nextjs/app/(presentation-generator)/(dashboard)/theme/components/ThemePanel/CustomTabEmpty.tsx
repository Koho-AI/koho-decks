    ...
    return (
        <div
            ...
            <div className='relative h-[250px] flex justify-center items-center '>
                ...
                <div className='w-[36px] h-[36px] relative z-[4]  rounded-full bg-[#00C278] flex items-center justify-center'
                    style={{
            ...
            <div className='px-5 py-4 bg-white flex items-center gap-4 border-t border-[#EDEEEF]'>
                <div className='bg-[#00C278] w-[45px] h-[45px] rounded-lg p-2 flex items-center justify-center'>
